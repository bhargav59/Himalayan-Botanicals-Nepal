...
export function Hero() {
  return (
    <section className="relative flex min-h-screen items-center overflow-hidden bg-gradient-to-br from-[hsl(var(--primary))] to-[hsl(var(--primary))]/80">
      ...
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,_hsl(var(--foreground))/60_0%,_transparent_70%)]" />
      ...
      <div className="relative mx-auto max-w-7xl px-4 pt-24 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <motion.p
            ...
            className="mt-6 text-lg text-[hsl(var(--primary-foreground))] sm:text-xl md:text-2xl"
          >
      ...
      <motion.div
        ...
        className="absolute bottom-0 left-0 right-0 border-t border-[hsl(var(--primary-foreground))]/10 bg-[hsl(var(--background))]/20 backdrop-blur-sm"
      >
          ...
          <div className="grid grid-cols-2 gap-6 md:grid-cols-4">
            {stats.map((stat) => (
              <div key={stat.label} className="text-center">
                ...
                <div className="mt-1 text-sm text-[hsl(var(--primary-foreground))]/90">
                  {stat.label}
                </div>
              </div>
            ))}
